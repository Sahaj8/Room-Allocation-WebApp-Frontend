...
const Activity = (activity) => {
    ...
    const handleApprove = () => {
        ...
        axios.patch(`https://e022-103-156-19-229.in.ngrok.io/activity/update/${newActivity._id}`, newActivity)
            .then(res => {
    ...
    const handleDelete = () => {
        axios.delete(`https://e022-103-156-19-229.in.ngrok.io/activity/delete/${activity._id}`)
            .then(res => {
                console.log(res.data)
                if(res.status === 401){
                    alert(res.data);
